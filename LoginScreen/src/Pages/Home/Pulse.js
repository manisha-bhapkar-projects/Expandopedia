...
const Pulse = (props) => {
  ...
  console.log("active",props.activePulseTab);
  return (
        ...
        <div className="tab-section col-12 mb-5">
          <div className="tab-header">
            ...
            <a
              ...
              onClick={() => setActivePulseTab("unemployment")}
            >
              UNEMPLOYMENT
            </a>
            <a
              ...
              onClick={() => setActivePulseTab("easeOfDoingBusiness")}
            >
              EASE OF BUSINESS
            </a>
          </div>
