...
const SubscriptionList = (props) => {
  ...
  let sendSubscriptionData = async (a) => {
    const response = await postSubscriptionData(a);
                  ...
                  <div className="col-lg-10">
                    <div className="vertical-tab-group subscription-item-wrapper">
                      <div className="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                        <ListFeatures data_event={eventtoggleChange} onInputChange={onFeatDataChange} sub_event={getDataFrm} feat_data={featData}></ListFeatures>
                      </div>
                    </div>
                    <div className="row">
                      <div className="col-12">
                      ...
                      <div className="col-sm-6">
                        <div className="price-container">
                          <label>Price</label>
                          <input id="input__username" onChange={(e) => onInputChangeHandler(e)} name="Price" type="number" pattern="\d*" min="1" maxLength={5} />
                      ...
                      <div className="col-sm-6">
                        <div className="price-container">
                          ...
                          <input id="input__username" maxLength={5} onChange={(e) => onInputChangeHandler(e)} name="PromotionPrice" type="number" />
                          <span className="currency-type">$</span>
                          <span className="currency-seperator"></span>
                          <CustomeDropDown
