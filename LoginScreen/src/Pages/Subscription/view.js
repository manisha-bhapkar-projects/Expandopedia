              ...
              <div className="title-action-wrap">
                <div className="row">
                  ...
                  <div className="col-sm-6 d-flex justify-content-end pr-0">
                    ...
                    <button type="button" onClick={() => openEditModal()} className="primary-button pointer">Edit</button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="col-12">
                ...
                <div className="row">
                  ...
                  <div className="col-lg-10">
                    ...
                    <div className="col-sm-6">
                      <div className="price-container">
                        <label>Price</label>
                        <input id="input__username"   name="Price" type="number" pattern="\d*" min="1" maxLength={5} value={subData ? subData.price : ""}/>
                    ...
                    <div className="col-sm-6">
                      <div className="price-container">
                        ...
                        <input id="input__username" maxLength={5}  name="PromotionPrice" type="number" value={subData ? subData.promotionPrice : ""} />
                        <span className="currency-type">$</span>
                  ...
                  <div className="col-12">
                    ...
                    <div className="price-container">
                        <label>Period</label>
                        <input id="input__username"   name="Duration" type="number" value={subData ? subData.duration : ""}/>
