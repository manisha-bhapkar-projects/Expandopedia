...
const ViewSubscription = (props) => {
    ...
    let sendSubscriptionData = async (a, id) => {
        const response = await EditSubscriptionData(a, id);
        props.notify(response.message, 5000);
        history.push('/subscription-list')
    }
    let promoCheckbox_html = () => {
        if (promoChecked != true) {
            return <label className="tab-checkbox">Apply Promo price<input type="checkbox" value="" /><span className="checkmark" ></span></label>;
        } else {
            return <label className="tab-checkbox">Apply Promo price<input type="checkbox" value="" defaultChecked='true' /><span className="checkmark" ></span></label>;
        }
    }
                        ...
                        <div className="breadcrump-admin mt-3 mb-3">
                            <nav aria-label="breadcrumb">
                                <ol className="breadcrumb pl-0">
                                    ...
                                    <li className="breadcrumb-item pointer link"><a onClick={() => history.push("/subscription-list")}>Subscriptions</a></li>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-sm-6">
                                                <div className="price-container">
                                                    <label>Price</label>
                                                    <input id="input__username" onChange={(e) => onInputChangeHandler(e)} name="Price" type="number" pattern="\d*" min="1" maxLength={5} defaultValue={subData ? subData.price : ""} />
                                            ...
                                            <div className="col-sm-6">
                                                <div className="price-container">
                                                    ...
                                                    <input id="input__username" maxLength={5} onChange={(e) => onInputChangeHandler(e)} name="PromotionPrice" type="number" defaultValue={subData ? subData.promotionPrice : ""} />
                                                    <span className="currency-type">$</span>
                                                    <span className="currency-seperator"></span>
                                                    <CustomeDropDown
