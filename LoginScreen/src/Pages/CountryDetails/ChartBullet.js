...
class ChartBullet extends Component {
  ...
  componentDidMount() {
    console.log(`chartdiv1${this.props.divId}`, this.props.isLogChart);
  ...
  createBulletChart(container, direction, logchart) {
   ...
   categoryAxis.tooltip.background.cornerRadius = 3;
    ...
    if(logchart==="true"){
      console.log("number",numberFormat(5000))
      series.tooltipText = `
      ...
      series.tooltipText = `
      ${this.props.chartData.value && `Country Value :${numberFormat((this.props.chartData.value ).toFixed(2))}%,`}
      ${this.props.chartData.value && `Global Median :${numberFormat((this.props.chartData.median ).toFixed(2))}%`}
      ${this.props.chartData.value && `Global Average :${numberFormat((this.props.chartData.average ).toFixed(2))}%`}
      `;
    }
    else{
      series.tooltipText = `
