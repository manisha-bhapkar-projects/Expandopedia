...
class ShareModal extends React.Component {
    ...
    componentDidMount() {
        ...
        console.log("after", selectedSuperTopics, selectedTopics, selectedSubTopics, selectedTerTopics)
        ...
        return (
            <>
                ...
                >
                    ...
                    <Modal.Footer className="share-popup-modal-footer">
                        <Button variant="primary" onClick={this.proceedPDFCreation.bind(this)}
                            disabled={this.props.country?.pdfLoading}
                        >
                            <span>
                                {this.props.country?.pdfLoading ?
