    ...
    <div className="container-fluid">
      ...
      <div className="row">
        <div className="compare-container col-12">
          ...
          <span className='pointer' href><i onClick={() =>hasCountryId? history.push(`/details/${countryData &&
              countryData.length &&
              countryData[0]?.country_Name
              ? countryData[0].id
              : ""
            }`):history.push('/home')} className="ph-arrow-left" /></span>
