...
const ComparePopup = (props) => {
  ...
  useEffect(() => {
    const result = selectedCountryDetails.filter((country) =>
      country.country_Name.toLowerCase().includes(searchItem)
    );
  ...
  return (
    <Modal {...props} aria-labelledby="exampleModalLabel" centered size="lg" className="modal_compare">
      <ModalHeader>
          ...
          <div className="row">
            <div className="col-12">
              <div className="form-group">
                <label htmlFor>Select Comparison Type</label>
                ...
                <div className="col">
                  <div className="select-country-wrapper">
                    <div className="country-search">
                      ...
                      {searchItem ? 
                        <span className="search_clear_btn"
                    ...
                    {countryList && countryList.length
                      ? countryList
                          ...
                          .map((item, index) => {
                            return (
                              <label className={ selectedCountry.find((e) => {
                                return e === item.country_Name;
                              })?"container-cb backColor":"container-cb"} key={index}>
                                {item.country_Name}
                                <input
                                  type="checkbox"
