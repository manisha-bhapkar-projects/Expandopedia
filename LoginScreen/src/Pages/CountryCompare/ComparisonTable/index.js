...
export default function App(props) {
    ...
    return (
        <div className={styles.container}>
            ...
            <div>
                <button className={`${styles.greater} ${styles.fixed} ${styles.nextBtn}`} onClick={() => onVisibleChange(false)}>

                </button>
                <button className={`${styles.lesser} ${styles.prevBtn}`} onClick={() => onVisibleChange(true)}>
                            ...
                            <tr key={index}>
                                ...
                                {countries.map((country, i) => {
                                    ...
                                    return (
                                        <td
                                            ...
                                            dangerouslySetInnerHTML={{
                                                __html: (detail?.supertopicName === "Taxes" ?
                                                    detail?.topics ?
                                                        detail?.topics.map((item => item?.topicName === "Social Security & Payroll Taxes" ? item?.topicSnapshotContent?.join(";") : ""))
                                                        : "No data"
                                        ...
                                        >
                                            {/* {stripHtml_fun(detail?.supertopicContent || "N/A")} */}
                                        </td>
                                    )
                                })
                                }
